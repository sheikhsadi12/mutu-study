...
export default function App() {
  ...
  const customFontData = useStore(state => state.customFontData);
  ...
  useEffect(() => {
    ...
    // Apply Font Family
    const fontToUse = fontFamily === 'Custom' && customFontName ? customFontName : fontFamily;
    ...
    root.style.setProperty('--font-sans', `"${fontToUse}", sans-serif`);
    root.style.fontFamily = `"${fontToUse}", sans-serif`;
  }, [theme, isDarkMode, fontFamily, customFontName, customFontData, customThemeColors]);
